...
add_file -type verilog [file join $root target tang_primer_20k ddr_array_top.sv]
add_file -type verilog [file join $root target tang_primer_20k ddr_array_scan_top.sv]
add_file -type verilog [file join $root target tang_primer_20k ddr_array_same_top.sv]
add_file -type verilog [file join $root target tang_primer_20k ddr_array_trace_top.sv]
add_file -type verilog [file join $root target tang_primer_20k ddr_array_match_top.sv]
...
add_file -type verilog [file join $root target tang_primer_20k ddr_array_full_timeline_top.sv]
add_file -type verilog [file join $root target tang_primer_20k ddr_array_expected_timeline_top.sv]
add_file -type verilog [file join $root target tang_primer_20k ddr_array_phase_timeline_top.sv]
